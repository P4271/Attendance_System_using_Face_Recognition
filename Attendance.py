...
# Reading images and Splitting names
...
# Reading the video capturing device
...
# compare faces and find face distance
    ...
    if cv2.waitKey(1) == 13:                    # => 13 is ascii value for ENTER Key 
        break
cap.release()
